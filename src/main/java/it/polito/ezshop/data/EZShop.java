...
public class EZShop implements EZShopInterface {
	...
	public Integer createProductType(String description, String productCode, double pricePerUnit, String note)
		...
		if (barCodeLength != 8 && barCodeLength != 12 && barCodeLength != 13 && barCodeLength != 14
				&& barCodeLength != 17 && barCodeLength != 18) {
			throw new InvalidProductCodeException();
		}
		...
		// If the calculated check digit does not correspond to the one to be verified,
		// it is invalid
		...
		ProductTypeClass productType = new ProductTypeClass(lastid + 1, 0, "location", note, description, productCode,
				pricePerUnit);
	...
	public List<ProductType> getAllProductTypes() throws UnauthorizedException {
		...
		if (user == null || !user.getRole().equals("Administrator") != !user.getRole().equals("ShopManager") != !user
				.getRole().equals("Cashier"))
			throw new UnauthorizedException();
	...
	public ProductType getProductTypeByBarCode(String barCode)
		...
		if (barCode == null || barCode.length() == 0 || !db.checkExistingProductType(barCode)) { // il checkExist ci
																									// vuole davvero?
			throw new InvalidProductCodeException();
		}
		// check barcode validity
	...
	public Integer payOrderFor(String productCode, int quantity, double pricePerUnit)
		...
		/**
		 * 
		 * This method affects the balance of the system. It can be invoked only after a
		 ...
		 *         balance is not enough to satisfy the order, if there are some ////TO
		 *         DOO!! The balance problems with the db
		 * 
		 */
